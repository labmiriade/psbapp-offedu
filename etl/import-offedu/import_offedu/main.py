        ...
        try:
            batch.put_item(
                Item={
                    ...
                    "sk": "p-info",
                    "data": {
                        "educationalOffer": get_or_error(row, "Offerta_Formativa"),
                        "code": get_or_error(row, "Codice"),
                        "website": get_or_error(row, "Sito_web"),
                        "placeId": place_id,
                        ...
                        "name": get_or_error(row, "Denominazione"),
                        "category": get_or_error(row, "Categoria").strip().lower(),
                        "type": get_or_error(row, "Tipo"),
            ...
            ids.add(place_id)
            if row["categoria"]:
                categories.add(row["categoria"].strip().lower())
        except Exception as error:
            errors.append(error)
